...
| `simhalt_directive` | `simhalt_is_an_instruction_of_four_bytes`, `simhalt_ignores_the_rest_of_its_line`, and `simhalt_pauses_after_itself_and_step_resumes` in `src/test/test.rs` |
